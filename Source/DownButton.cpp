...
//==============================================================================
DownButton::DownButton (AudioEngine* audioEngine_)
...
void DownButton::resized()
{
    internalPath1.clear();
    internalPath1.startNewSubPath (30.0f, 30.0f);
    internalPath1.lineTo (54.0f, 5.0f);
    internalPath1.lineTo (5.0f, 5.0f);
...
void DownButton::setPressure(float p)
{
...
<JUCER_COMPONENT documentType="Component" className="DownButton" componentName=""
  ...
  <BACKGROUND backgroundColour="ff2b2b2b">
    <PATH pos="0 0 100 100" fill=" radial: 40 32, 56 24, 0=ffffffff, 1=ffe4e4e4"
          ...
          nonZeroWinding="1">s 30 30 l 54 5 l 5 5 x</PATH>
  </BACKGROUND>
</JUCER_COMPONENT>
