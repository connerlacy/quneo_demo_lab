...
//==============================================================================
RhombusButton::RhombusButton (AudioEngine* audioEngine_)
...
//==============================================================================
void RhombusButton::paint (Graphics& g)
{
...
else
{
    ...
    g.fillEllipse(24.0f - pressure/2.0f, 16.0f - pressure/2.0f, pressure, pressure);
    ...
    //Pressure border
    g.drawEllipse(24.0f - pressure/2.0f, 16.0f - pressure/2.0f, pressure, pressure,pressure/7.0f);
...
void RhombusButton::resized()
{
    internalPath1.clear();
    internalPath1.startNewSubPath (24.0f, 8.0f);
    internalPath1.lineTo (40.0f, 16.0f);
    internalPath1.lineTo (24.0f, 24.0f);
...
void RhombusButton::setPressure(float p)
{
...
<JUCER_COMPONENT documentType="Component" className="RhombusButton" componentName=""
  ...
  <BACKGROUND backgroundColour="2b2b2b">
    <PATH pos="0 0 100 100" fill=" radial: 40 32, 56 24, 0=ffffffff, 1=ffe4e4e4"
          ...
          nonZeroWinding="1">s 24 8 l 40 16 l 24 24 l 8 16 x</PATH>
  </BACKGROUND>
</JUCER_COMPONENT>
