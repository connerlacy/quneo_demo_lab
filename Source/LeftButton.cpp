...
//==============================================================================
LeftButton::LeftButton (AudioEngine* audioEngine_)
...
//==============================================================================
void LeftButton::paint (Graphics& g)
{
...
else
{
    ...
    g.fillEllipse(14.0f - pressure/2.0f, 17.0f - pressure/2.0f, pressure, pressure);
    ...
    //Pressure border
    g.drawEllipse(14.0f - pressure/2.0f, 17.0f - pressure/2.0f, pressure, pressure,pressure/7.0f);
...
void LeftButton::resized()
{
    internalPath1.clear();
    internalPath1.startNewSubPath (25.0f, 5.0f);
    internalPath1.lineTo (5.0f, 17.0f);
    internalPath1.lineTo (25.0f, 30.0f);
...
void LeftButton::setPressure(float p)
{
...
<JUCER_COMPONENT documentType="Component" className="LeftButton" componentName=""
  ...
  <BACKGROUND backgroundColour="ff2b2b2b">
    <PATH pos="0 0 100 100" fill=" radial: 40 32, 56 8, 0=ffffffff, 1=ffe4e4e4"
          hasStroke="1" stroke="3, curved, rounded" strokeColour="solid: ff777777"
          nonZeroWinding="1">s 25 5 l 5 17 l 25 30 x</PATH>
  </BACKGROUND>
</JUCER_COMPONENT>
