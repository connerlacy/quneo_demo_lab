...
//==============================================================================
RightButton::RightButton (AudioEngine* audioEngine_)
...
void RightButton::resized()
{
    internalPath1.clear();
    internalPath1.startNewSubPath (5.0f, 5.0f);
    internalPath1.lineTo (25.0f, 17.0f);
...
void RightButton::setState(bool st)
{
    state = st;
    if(state)
    {
...
void RightButton::setPressure(float p)
{
...
<JUCER_COMPONENT documentType="Component" className="RightButton" componentName=""
  ...
  <BACKGROUND backgroundColour="ff2b2b2b">
    <PATH pos="0 0 100 100" fill=" radial: 40 32, 56 24, 0=ffffffff, 1=ffe4e4e4"
          ...
          nonZeroWinding="1">s 5 5 l 25 17 l 5 30 x</PATH>
  </BACKGROUND>
</JUCER_COMPONENT>
