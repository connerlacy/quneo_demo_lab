...
//==============================================================================
RecordButton::RecordButton (AudioEngine* audioEngine_)
...
//==============================================================================
void RecordButton::paint (Graphics& g)
{
...
else
{
    ...
    g.fillEllipse(24.0f - pressure/2.0f, 24.0f - pressure/2.0f, pressure, pressure);
    ...
    //Pressure border
    g.drawEllipse(24.0f - pressure/2.0f, 24.0f - pressure/2.0f, pressure, pressure,pressure/7.0f);
...
{
    internalPath1.clear();
    internalPath1.startNewSubPath (24.0f, 8.0f);
    internalPath1.lineTo (40.0f, 24.0f);
    internalPath1.lineTo (24.0f, 40.0f);
...
void RecordButton::setState(bool st)
{
    state = st;
    this->repaint();
}

void RecordButton::setPressure(float p)
{
...
<JUCER_COMPONENT documentType="Component" className="RecordButton" componentName=""
  ...
  <BACKGROUND backgroundColour="ff2b2b2b">
    <PATH pos="0 0 100 100" fill=" radial: 24 24, 64 72, 0=ffffffff, 1=ffe4e4e4"
          hasStroke="1" stroke="3, curved, rounded" strokeColour="solid: ff777777"
          nonZeroWinding="1">s 24 8 l 40 24 l 24 40 l 8 24 x</PATH>
  </BACKGROUND>
</JUCER_COMPONENT>
